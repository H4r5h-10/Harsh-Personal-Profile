...
const Contact = () => {
  ...
  onBlur={(e) => e.target.placeholder = "Your Name"}/>
          <input type="text" name='email' placeholder="Your Email" onFocus={(e) => e.target.placeholder = ""} 
  onBlur={(e) => e.target.placeholder = "Your Email"}/>
          <textarea name="message" placeholder="Leave your message here..." onFocus={(e) => e.target.placeholder = ""} 
  onBlur={(e) => e.target.placeholder = "Leave your message here..."}></textarea>
          <div>
